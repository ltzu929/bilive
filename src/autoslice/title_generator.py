...
def generate_title(video_path, artist):
    """Generate title or return an AnalysisResult for advanced providers."""
    pass


def extract_title(result):
    """Extract a title string from plain or AnalysisResult responses."""
