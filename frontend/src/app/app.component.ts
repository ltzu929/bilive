...
import { StudioPreferencesService } from './studio/studio-preferences.service';
...
export class AppComponent implements OnDestroy {
  ...
  constructor(
    ...
    preferences: StudioPreferencesService
  ) {
    this.collapsed = preferences.value.collapseSidebar;
    preferences.preferences$
      .pipe(takeUntil(this.destroyed))
      .subscribe((value) => {
        if (!this.useDrawer) {
          this.collapsed = value.collapseSidebar;
